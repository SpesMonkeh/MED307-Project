...
{
  public class MemorizedLogger : IExtendedLogger
  {
    public readonly struct LogStruct
    {
      ...
      static LogLevel GetLogLevelFromLogType(LogType logType) => logType switch
      {
    ...
    public MemorizedLogger(int historySize = 0)
    {
